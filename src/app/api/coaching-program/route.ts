...
const mockData: CoachingProgramData = {
  intro: {
    ...
    description: "Step Into a season of intentional self-discovery and growth with our Collaborative Coaching Program. Our customizable packages honor your unique path while offering the insight and support of distinct yet complementary coaching styles.\n\nDesign your experience your way: choose a trusted advisor from any of our Lifeing Coaches based on your needs, goals, and rhythm. Work closely with one coach or blend sessions across our team - the choice is yours to make."
  },
  packages: [
    {
      id: "discovery",
      ...
      description: "Explore with up to four different coaches through introductory or follow-up sessions. Perfect for sampling perspectives and finding the right fit.",
    ...
    },
    {
      ...
      description: "Build momentum with focused sessions customized to your goals. Choose a single coach for depth or mix coaches for variety and fresh insight.",
    ...
    },
    {
      ...
      description: "Our best value for ongoing support and accountability. Gain consistent, personalized coaching with one or multiple coaches in your chosen areas of focus.",
