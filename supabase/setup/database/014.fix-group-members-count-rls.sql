-- Migration: Fix group_members RLS policy to allow reading approved memberships for counting
-- Description: Optimizes group membership visibility for counting and public information
-- This allows reading approved memberships while still protecting pending requests
